...
"FileTypes: html xml
autocmd FileType html vmap <buffer> <s-â> <m-s-b>

autocmd FileType html imap <buffer> <m-s-x> <c-r>=<SID>FindBack('big')<CR>
autocmd FileType html imap <buffer> <m-x> <c-r>=<SID>FindBack('b')<CR>
autocmd FileType html imap <buffer> <m-m> <c-r>=<SID>FindBack('i')<CR>
autocmd FileType html imap <buffer> <m-u> <c-r>=<SID>FindBack('u')<CR>
autocmd FileType html imap <buffer> <m-p> <c-r>=<SID>FindBack('p')<CR>
autocmd FileType html imap <buffer> <m-k> <c-r>=<SID>FindBack('kbd')<CR>
autocmd FileType html imap <buffer> <m-t> <c-r>=<SID>FindBack('td')<cr>
autocmd FileType html vmap <buffer> <m-s-b> :call <SID>SurroundHTM('big')<CR>
autocmd FileType html vmap <buffer> <m-b> :call <SID>SurroundHTM('b')<CR>
autocmd FileType html vmap <buffer> <m-m> :call <SID>SurroundHTM('i')<CR>
autocmd FileType html vmap <buffer> <m-u> :call <SID>SurroundHTM('u')<CR>
autocmd FileType html vmap <buffer> <m-p> :call <SID>SurroundHTM('p')<CR>
autocmd FileType html vmap <buffer> <m-k> :call <SID>SurroundHTM('kbd')<CR>
autocmd FileType html vmap <buffer> <m-d> :call <SID>SurroundHTM('td')<CR>
autocmd FileType html nmap <buffer> <m-s-b> i<m-s-b>
autocmd FileType html nmap <buffer> <m-b> i<m-b>
autocmd FileType html nmap <buffer> <m-m> i<m-m>
autocmd FileType html nmap <buffer> <m-u> i<m-u>
autocmd FileType html nmap <buffer> <m-p> i<m-p>
"autocmd FileType html nmap<buffer>  <m-k> i<m-k>
autocmd FileType html nmap <buffer> <m-d> i<m-d>

autocmd FileType html imap <buffer> <m-8> <li></li><esc>F<i
autocmd FileType html nmap <buffer> <m-8> i<m-8>
autocmd FileType html vmap <buffer> <m-8> :call <SID>SurroundHTM('li')<cr>

autocmd FileType html imap <buffer> <m-.> <ol><CR></ol><esc>F<O<TAB>
autocmd FileType html nmap <buffer> <m-.> o<m-.>
autocmd FileType html imap <buffer> <m-,> <lt>ul><cr></ul><esc>F<O<TAB>
autocmd FileType html nmap <buffer> <m-,> o<m-,>

if !exists('htmlcmd_NOHEADER')
autocmd FileType html imap <buffer> <m-0> <c-r>=substitute(g_html_htmlheader,'%VERSION%',strpart(v:version,0,1).'.'.strpart(v:version,1,1),'')<cr>
endif
autocmd FileType html vmap <buffer> <m-1> :call <SID>SurroundHTM('h1')<cr>
autocmd FileType html vmap <buffer> <m-2> :call <SID>SurroundHTM('h2')<cr>
autocmd FileType html vmap <buffer> <m-3> :call <SID>SurroundHTM('h3')<cr>
autocmd FileType html vmap <buffer> <m-4> :call <SID>SurroundHTM('h4')<cr>
autocmd FileType html vmap <buffer> <m-5> :call <SID>SurroundHTM('h5')<cr>
autocmd FileType html vmap <buffer> <m-6> :call <SID>SurroundHTM('h6')<cr>
autocmd FileType html imap <buffer> <m-1> <c-r>=<SID>FindBack('h1')<cr>
autocmd FileType html imap <buffer> <m-2> <c-r>=<SID>FindBack('h2')<cr>
autocmd FileType html imap <buffer> <m-3> <c-r>=<SID>FindBack('h3')<cr>
autocmd FileType html imap <buffer> <m-4> <c-r>=<SID>FindBack('h4')<cr>
autocmd FileType html imap <buffer> <m-5> <c-r>=<SID>FindBack('h5')<cr>
autocmd FileType html imap <buffer> <m-6> <c-r>=<SID>FindBack('h6')<cr>
autocmd FileType html nmap <buffer> <m-1> i<m-1>
autocmd FileType html nmap <buffer> <m-2> i<m-2>
autocmd FileType html nmap <buffer> <m-3> i<m-3>
autocmd FileType html nmap <buffer> <m-4> i<m-4>
autocmd FileType html nmap <buffer> <m-5> i<m-5>
autocmd FileType html nmap <buffer> <m-6> i<m-6>

autocmd FileType html imap <buffer> <c-cr> <esc>o
autocmd FileType html imap <buffer> <s-cr> <lt>br/><CR>
autocmd FileType html imap <buffer> <m--> <lt>hr/>

autocmd FileType html imap <buffer> &<space> &nbsp;
autocmd FileType html imap <buffer> && &amp;
autocmd FileType html imap <buffer> &< &lt;
autocmd FileType html imap <buffer> &> &gt;
if 0
autocmd FileType html imap <buffer> &'< &lsquo;
autocmd FileType html imap <buffer> &'> &rsquo;
autocmd FileType html imap <buffer> &"< &ldquo;
autocmd FileType html imap <buffer> &"> &rdquo;
endif
...
endfun
autocmd FileType html imap <buffer> &' <c-r>=<SID>HTMLQuote('squo')<CR>
autocmd FileType html imap <buffer> &" <c-r>=<SID>HTMLQuote('dquo')<CR>
...
if exists("htmlcmd_BF")
  autocmd FileType html imap <buffer> <m-<> &lt;
  autocmd FileType html imap <buffer> <m->> &gt;
  autocmd FileType html imap <buffer> <m-&> &amp;
  autocmd FileType html imap <buffer> <m-l> <a href=""><Left><Left>
  autocmd FileType html imap <buffer> <m-n> <a name=""><Left><Left>
endif
...
autocmd FileType html nmap ,al "='<a href="'.@*.'" target="_top"></a>'<cr>p
autocmd FileType html nmap ,aL "='<li><a href="'.@*.'" target="_top"></a></li>'<cr>p
autocmd FileType html nmap ,l "='<a href="#'.@".'"></a>'<cr>p
"nmap ,yf :let @*='file:///'.expand('%:p:gs+\+/+')<cr>
autocmd FileType html nmap ,yf :let @*=<SID>URLPathOf(expand('%:p'))<cr>
...
autocmd FileType html imap <buffer> <m-;> <c-r>=<SID>CloseLast(0)<CR>
autocmd FileType html imap <buffer> <m-s-;> <c-r>=<SID>CloseLast(1)<CR>
autocmd FileType html imap <buffer> º <m-s-;>
...
" Close everything
autocmd FileType html imap <buffer> ¾ <m->>
autocmd FileType html imap <buffer> <m->> <c-r>=<SID>HTMLCloseAll(0,0,line('$')+1,0,line('.'),col('.'))<cr>
